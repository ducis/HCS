...
{
  PWMDTY0 = (byte)(((100 * (dword)RatioStore) + 32768) >> 16); /* Calculate new value according to the given ratio */
}
...
byte PWM9_SetDutyUS(word Time)
{
  ...
  if (Time > 2) {                      /* Is the given value out of range? */
...
void PWM9_Init(void)
{
  ...
  /* PWMDTY0: BIT7=0,BIT6=0,BIT5=0,BIT4=1,BIT3=1,BIT2=0,BIT1=0,BIT0=1 */
  setReg8(PWMDTY0, 25);                /* Store initial value to the duty-compare register */ 
  /* PWMPER0: BIT7=0,BIT6=1,BIT5=1,BIT4=0,BIT3=0,BIT2=1,BIT1=0,BIT0=0 */
  setReg8(PWMPER0, 100);               /* and to the period register */ 
  ...
  /* PWMCLK: PCLK0=0 */
  clrReg8Bits(PWMCLK, 1);              /* Select clock source */ 
  /* PWME: PWME0=1 */
