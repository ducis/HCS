...
#define CPU_DERIVATIVE_MC9S12XDT256    /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MC9S12XDT256BMPV   /* Part number of the selected cpu */
