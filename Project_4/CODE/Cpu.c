...
/*
** ===================================================================
**     Method      :  Cpu_Delay100US (bean MC9S12XS256_80)
**
**     Description :
...
void Cpu_Delay100US(word us100)
{
  ...
  asm {
    ...
    ldd #1330                          /* (2 c: 50 ns) number of iterations */
    label0:
...
void PE_low_level_init(void)
{
  ...
  /* PTS: PTS1=1 */
  setReg8Bits(PTS, 2);                  
  /* DDRS: DDRS7=1,DDRS6=1,DDRS5=1,DDRS4=1,DDRS1=1,DDRS0=0 */
  clrSetReg8Bits(DDRS, 1, 242);         
