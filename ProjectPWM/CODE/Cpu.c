...
void PE_low_level_init(void)
{
  ...
  setReg8(PWME, 0);                     
  /* PTTRR: PTTRR7=0,PTTRR5=0,PTTRR4=0 */
  clrReg8Bits(PTTRR, 176);              
  /* PWMCTL: CON67=1,CON45=0,PSWAI=0,PFRZ=0 */
  clrSetReg8Bits(PWMCTL, 76, 128);      
  /* PWMCAE: CAE7=0,CAE5=0,CAE4=0 */
  clrReg8Bits(PWMCAE, 176);             
  /* PWMPOL: PPOL7=0,PPOL5=0,PPOL4=0 */
  clrReg8Bits(PWMPOL, 176);             
  /* PTP: PTP7=0,PTP5=0,PTP4=0 */
  clrReg8Bits(PTP, 176);                
  /* DDRP: DDRP7=1,DDRP5=1,DDRP4=1 */
  setReg8Bits(DDRP, 176);               
  /* PITCFLMT: PITE=0 */
  ...
  /* PORTB: PB7=1,PB6=1,PB5=1,PB4=1,PB3=1,PB2=1,PB1=1,PB0=1 */
  setReg8(PORTB, 255);                  
  /* PUCR: PUPBE=0 */
  clrReg8Bits(PUCR, 2);                 
  ...
  /* ### InputPin "InpB2" init code ... */
  /* ### InputPin "InpB3" init code ... */
  /* ### TimerInt "TI1" init code ... */
  /* PITLD0: PLD15=0,PLD14=0,PLD13=0,PLD12=1,PLD11=1,PLD10=1,PLD9=1,PLD8=1,PLD7=0,PLD6=1,PLD5=0,PLD4=0,PLD3=0,PLD2=0,PLD1=0,PLD0=0 */
  setReg16(PITLD0, 8000);              /* Store given value to the compare register */ 
  /* PITCE: PCE0=1 */
  setReg8Bits(PITCE, 1);               /* Enable Timer */ 
  /* ### ByteIO "Byte1" init code ... */
  Shadow_B = (byte)255;                /* Initialize port "Byte1" shadow variable */
