...
void PE_low_level_init(void)
{
  ...
  /* PITLD0: PLD15=0,PLD14=0,PLD13=0,PLD12=0,PLD11=0,PLD10=0,PLD9=0,PLD8=1,PLD7=1,PLD6=0,PLD5=0,PLD4=1,PLD3=0,PLD2=0,PLD1=0,PLD0=0 */
  setReg16(PITLD0, 400);               /* Store given value to the compare register */ 
  /* PITCE: PCE0=1 */
