...
#define PWM8_PERIOD_VALUE    255UL     /* Initial period value in ticks of the timer */
#define PWM8_PERIOD_VALUE_HIGH 255UL   /* Initial period value in ticks of the timer in high speed mode */
