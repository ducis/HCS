...
void PE_low_level_init(void)
{
  ...
  setReg8(INT_CFDATA4, 4);             /*  0x3C  0xFF78   4   no   ivVpit1        used by PE */ 
  setReg8(INT_CFADDR, 224);             
  setReg8(INT_CFDATA4, 4);             /*  0x74  0xFFE8   4   no   ivVtimch3      used by PE */ 
  setReg8(INT_CFDATA6, 4);             /*  0x76  0xFFEC   4   no   ivVtimch1      used by PE */ 
  /* Common initialization of the CPU registers */
  /* TCTL4: EDG3B=0,EDG3A=0,EDG1B=0,EDG1A=0 */
  clrReg8Bits(TCTL4, 204);              
  /* TIE: C3I=0,C1I=0 */
  clrReg8Bits(TIE, 10);                 
  /* TIOS: IOS3=0,IOS1=0 */
  clrReg8Bits(TIOS, 10);                
  ...
  setReg8Bits(PITTF, 2);                
  /* PITINTE: PINTE1=1 */
  setReg8Bits(PITINTE, 2);              
  /* PITMTLD0: PMTLD7=0,PMTLD6=1,PMTLD5=1,PMTLD4=1,PMTLD3=0,PMTLD2=0,PMTLD1=1,PMTLD0=1 */
  setReg8(PITMTLD0, 115);               
  /* PITMUX: PMUX1=0 */
  clrReg8Bits(PITMUX, 2);               
  ...
  /* PITLD1: PLD15=1,PLD14=1,PLD13=1,PLD12=1,PLD11=1,PLD10=1,PLD9=1,PLD8=1,PLD7=1,PLD6=1,PLD5=1,PLD4=1,PLD3=1,PLD2=1,PLD1=1,PLD0=1 */
  setReg16(PITLD1, 65535);             /* Store given value to the compare register */ 
  /* PITCE: PCE1=1 */
  setReg8Bits(PITCE, 2);               /* Enable Timer */ 
