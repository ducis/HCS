...
#pragma DATA_SEG PORTB_DATA
#pragma CODE_SEG PORTB_CODE
#pragma CONST_SEG PORTB_CONST          /* Constant section for this module */
/*
** ===================================================================
**     Method      :  PORTB_GetMsk (bean ByteIO)
**
**     Description :
...
** ===================================================================
*/
static const byte PORTB_Table[8] = {
  1, 2, 4, 8, 16, 32, 64, 128
};                                     /* Table of mask constants */

static byte PORTB_GetMsk (byte PinIndex)
{
  return PORTB_Table[PinIndex];        /* Return appropriate bit mask */
}
...
*/
/*
byte PORTB_GetVal(void)

**  This method is implemented as a macro. See PORTB.h file.  **
*/
...
{
  byte const Mask = PORTB_GetMsk(Bit); /* Temporary variable - bit mask to test */
...
{
  byte const Mask = PORTB_GetMsk(Bit); /* Temporary variable - put bit mask */
  if (Val) {
...
{
  byte const Mask = PORTB_GetMsk(Bit); /* Temporary variable - set bit mask */
  setReg8Bits(PORTB, Mask);            /* [bit Bit]=1 */
}
