...
#define Cap1_PRESCALER_VALUE 2U        /* Initial prescaler value of the timer */
#define Cap1_TIMER_INPUT_CLOCK 8000000UL /* DEPRECATED. Initial timer input clock frequency [Hz] */
#define Cap1_COUNTER_INPUT_CLOCK_HZ 4000000UL /* Initial counter input clock frequency [Hz] */
/* High speed mode constants */
#define Cap1_PRESCALER_VALUE_HIGH 2U   /* Initial prescaler value of the timer in high speed mode */
#define Cap1_TIMER_INPUT_CLOCK_HIGH 8000000UL /* DEPRECATED. Timer input clock frequency [Hz] in high speed mode */
#define Cap1_COUNTER_INPUT_CLOCK_HZ_HIGH 4000000UL /* Initial counter input clock frequency [Hz] in high speed mode */
...
#define Cap1_GetCaptureValue(Value) \
 (*(Cap1_TCapturedValue*)(Value) = (TC5 - Cap1_CntrState), ERR_OK)
/*
** ===================================================================
