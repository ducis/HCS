...
#define PWM2_PERIOD_VALUE    250UL     /* Initial period value in ticks of the timer */
#define PWM2_PERIOD_VALUE_HIGH 250UL   /* Initial period value in ticks of the timer in high speed mode */
