...
static void HWEnDi(void)
{
  if (EnUser) {                        /* Enable device? */
    ...
    PWME_PWME3 = 0;                    /* Stop counter */
    PWMCNT3 = 0;                       /* Reset counter */
  }
}
...
{
  PWMDTY3 = (byte)(((250 * (dword)RatioStore) + 32768) >> 16); /* Calculate new value according to the given ratio */
}
...
void PWM3_Init(void)
{
  ...
  setReg8(PWMCNT3, 0);                 /* Reset Counter */ 
  ...
  /* PWMDTY3: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=0,BIT0=1 */
  setReg8(PWMDTY3, 125);               /* Store initial value to the duty-compare register */ 
  /* PWMPER3: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=1,BIT0=0 */
  setReg8(PWMPER3, 250);               /* and to the period register */ 
  /* PWMCLK: PCLK3=1 */
  setReg8Bits(PWMCLK, 8);              /* Select clock source */ 
