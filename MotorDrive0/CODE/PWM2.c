...
**         Compare 1 register          : PWMPER2   [790]
**         Compare 2 register          : PWMDTY2   [798]
...
**         SetDutyTicks16 - byte PWM2_SetDutyTicks16(word Ticks);
...
static void HWEnDi(void)
{
  if (EnUser) {                        /* Enable device? */
    PWME_PWME2 = 1;                    /* Run counter */
  } else {                             /* Disable device? */
    PWME_PWME2 = 0;                    /* Stop counter */
    PWMCNT2 = 0;                       /* Reset counter */
  }
}
...
{
  PWMDTY2 = (byte)(((250 * (dword)RatioStore) + 32768) >> 16); /* Calculate new value according to the given ratio */
}

/*
** ===================================================================
**     Method      :  PWM2_Enable (bean PWM)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  PWM2_SetRatio16 (bean PWM)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  PWM2_SetDutyTicks16 (bean PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM2_SetDutyTicks16(word Ticks)
{
...
/*
** ===================================================================
**     Method      :  PWM2_SetDutyUS (bean PWM)
**
**     Description :
...
void PWM2_Init(void)
{
  ...
  setReg8(PWMCNT2, 0);                 /* Reset Counter */ 
  ...
  /* PWMDTY2: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=0,BIT0=1 */
  setReg8(PWMDTY2, 125);               /* Store initial value to the duty-compare register */ 
  /* PWMPER2: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=1,BIT0=0 */
  setReg8(PWMPER2, 250);               /* and to the period register */ 
  /* PWMPRCLK: ??=0,PCKB2=0,PCKB1=0,PCKB0=0,??=0,PCKA2=0,PCKA1=0,PCKA0=0 */
  setReg8(PWMPRCLK, 0);                /* Set prescaler register */ 
  /* PWMSCLB: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=1,BIT2=0,BIT1=0,BIT0=0 */
  setReg8(PWMSCLB, 8);                 /* Set scale register */ 
  /* PWMCLK: PCLK2=1 */
  setReg8Bits(PWMCLK, 4);              /* Select clock source */ 
