...
void PWM5_Init(void)
{
  ...
  /* PWMDTY5: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=0,BIT0=1 */
  setReg8(PWMDTY5, 125);               /* Store initial value to the duty-compare register */ 
