...
**         SetDutyTicks16 - byte PWM4_SetDutyTicks16(word Ticks);
...
{
  PWMDTY4 = (byte)(((250 * (dword)RatioStore) + 32768) >> 16); /* Calculate new value according to the given ratio */
}

/*
** ===================================================================
**     Method      :  PWM4_Enable (bean PWM)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  PWM4_SetRatio16 (bean PWM)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  PWM4_SetDutyTicks16 (bean PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM4_SetDutyTicks16(word Ticks)
{
...
/*
** ===================================================================
**     Method      :  PWM4_SetDutyUS (bean PWM)
**
**     Description :
...
void PWM4_Init(void)
{
  ...
  /* PWMDTY4: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=0,BIT0=1 */
  setReg8(PWMDTY4, 125);               /* Store initial value to the duty-compare register */ 
  /* PWMPER4: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=1,BIT0=0 */
  setReg8(PWMPER4, 250);               /* and to the period register */ 
  /* PWMCLK: PCLK4=1 */
