...
**         Compare 1 register          : PWMPER1   [789]
**         Compare 2 register          : PWMDTY1   [797]
...
**         SetDutyTicks16 - byte PWM1_SetDutyTicks16(word Ticks);
...
static void HWEnDi(void)
{
  if (EnUser) {                        /* Enable device? */
    ...
    PWME_PWME1 = 0;                    /* Stop counter */
    PWMCNT1 = 0;                       /* Reset counter */
  }
}
...
{
  PWMDTY1 = (byte)(((250 * (dword)RatioStore) + 32768) >> 16); /* Calculate new value according to the given ratio */
}

/*
** ===================================================================
**     Method      :  PWM1_Enable (bean PWM)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  PWM1_SetDutyTicks16 (bean PWM)
**
**     Description :
...
** ===================================================================
*/
byte PWM1_SetDutyTicks16(word Ticks)
{
...
void PWM1_Init(void)
{
  /* PWMCNT1: BIT7=0,BIT6=0,BIT5=0,BIT4=0,BIT3=0,BIT2=0,BIT1=0,BIT0=0 */
  setReg8(PWMCNT1, 0);                 /* Reset Counter */ 
  ...
  /* PWMDTY1: BIT7=0,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=1,BIT1=0,BIT0=1 */
  setReg8(PWMDTY1, 125);               /* Store initial value to the duty-compare register */ 
  /* PWMPER1: BIT7=1,BIT6=1,BIT5=1,BIT4=1,BIT3=1,BIT2=0,BIT1=1,BIT0=0 */
  setReg8(PWMPER1, 250);               /* and to the period register */ 
  /* PWMCLK: PCLK1=1 */
  setReg8Bits(PWMCLK, 2);              /* Select clock source */ 
