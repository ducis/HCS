...
#define Cap2_PRESCALER_VALUE 256U      /* Initial prescaler value of the timer */
#define Cap2_TIMER_INPUT_CLOCK 8000000UL /* DEPRECATED. Initial timer input clock frequency [Hz] */
#define Cap2_COUNTER_INPUT_CLOCK_HZ 31250UL /* Initial counter input clock frequency [Hz] */
/* High speed mode constants */
#define Cap2_PRESCALER_VALUE_HIGH 256U /* Initial prescaler value of the timer in high speed mode */
#define Cap2_TIMER_INPUT_CLOCK_HIGH 8000000UL /* DEPRECATED. Timer input clock frequency [Hz] in high speed mode */
#define Cap2_COUNTER_INPUT_CLOCK_HZ_HIGH 31250UL /* Initial counter input clock frequency [Hz] in high speed mode */
...
#define Cap2_GetCaptureValue(Value) \
 (*(Cap2_TCapturedValue*)(Value) = (TC4 - Cap2_CntrState), ERR_OK)
/*
** ===================================================================
